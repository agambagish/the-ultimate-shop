...
import {
  ...
  SortableItemHandle,
  SortableOverlay,
} from "@/components/global/sortable";
...
interface Props<TData> extends React.ComponentProps<typeof PopoverContent> {
  table: Table<TData>;
}

export function DataTableSortList<TData>({ table, ...props }: Props<TData>) {
  const id = useId();
  const labelId = useId();
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            size="sm"
            // @ts-expect-error IDK, it's working fine
